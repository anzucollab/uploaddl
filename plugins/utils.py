...
@Client.on_message(filters.private & filters.incoming & filters.command(['restart'])
...
def map(pos):
    if(pos==1):
        ...
        button = [
            [
             InlineKeyboardButton(text = 'Feature Request', url = "https://github.com/ShinchanNohara1/UpgradedAnydlbot")
            ],
